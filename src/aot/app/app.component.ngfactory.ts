...
class View_AppComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._AppComponent_0_3 = new Wrapper_AppComponent(this.injectorGet(import8.FacebookService,this.parentIndex));
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  _RouterOutlet_0_5:import11.Wrapper_RouterOutlet;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._RouterOutlet_0_5 = new import11.Wrapper_RouterOutlet(this.parentView.injectorGet(import12.RouterOutletMap,this.parentIndex),this._vc_0.vcRef,this.parentView.injectorGet(import13.ComponentFactoryResolver,this.parentIndex),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import14.RouterOutlet) && (0 === requestNodeIndex))) { return this._RouterOutlet_0_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
